...
import ru.raptors.team.formzilla.activities.NewEmployeeActivity;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(nowUser != null) {
            ...
            if (staff == null || staff.isEmpty()) {
                ...
                textView.setText("Нет сотрудников в подчинении");
                placeHolder.addView(textView);
            }
        }
        FloatingActionButton fab = (FloatingActionButton) view.findViewById(R.id.addStaffButton);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent createEmployeeIntent = new Intent(getActivity(), NewEmployeeActivity.class);
